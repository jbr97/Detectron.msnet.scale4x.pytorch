...
import roi_data.rpn
import roi_data.zipreader as zipreader
...
def _get_image_blob(roidb):
    ...
    for i in range(num_images):
        ...
        im = zipreader.imread(roidb[i]['image'], cv2.IMREAD_COLOR | cv2.IMREAD_IGNORE_ORIENTATION)
        ...
        im, im_scale = blob_utils.prep_im_for_blob(
            ...
            im, cfg.NORM_MEANS, cfg.NORM_STDS, [target_size], cfg.TRAIN.MAX_SIZE)
