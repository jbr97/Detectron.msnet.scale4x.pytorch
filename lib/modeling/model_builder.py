...
import utils.detmsnet_weights_helper as detmsnet_utils
...
class Generalized_RCNN(nn.Module):
    ...
    def _init_modules(self):
        if cfg.MODEL.LOAD_IMAGENET_PRETRAINED_WEIGHTS:
            ...
            elif cfg.MSNET.IMAGENET_PRETRAINED_WEIGHTS:
                detmsnet_utils.load_pretrained_imagenet_weights(self.Conv_Body)
            else:
                assert False, 'Path IMAGENET_PRETRAINED_WEIGHTS error.'
    ...
    def _forward(self, data, im_info, roidb=None, **rpn_kwargs):
        ...
        #print(blob_conv.max(), blob_conv.min())
