...
class JsonDataset(object):
    ...
    def __init__(self, name):
        # change the position of import, cause DATA_DIR may change
    ...
    @property
    def cache_path(self):
        # change cache_path from DATA_DIR to ROOT_DIR
        cache_path = os.path.abspath(os.path.join(cfg.ROOT_DIR, 'cache'))
